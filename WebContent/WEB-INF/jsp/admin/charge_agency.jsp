...
<div style="width: 100%; float: left;">
		<div style="width: 33%; float: left;">
			<dl class="list"; style="font-size:14px;">
				<dt style="background:#FFFFFF; color:#330066; text-align:center; padding:5px; font-size:24px;">Agency Charges</dt>	
				<dd style="background:#FFFFFF; color:#330066; text-align:center; padding:5px; font-size:24px;"></dd> 	
				<dt style="background:#FFFFFF; color:#a64dff; text-align:left; padding:5px; font-size:14px;"><c:out value="${reservation.reservation_number}" /></dt>	
				<dd style="background:#FFFFFF; color:#a64dff; text-align:center; padding:5px; font-size:14px;"></dd> 	 	
				<hr>	 
		...
		<div style="width: 34%; float: left;">
			<dl class="list"; style="font-size:14px;">
				<dt style="background:#FFFFFF; color:#330066; text-align:center; padding:5px; font-size:24px;"></dt>	
				<dd style="background:#FFFFFF; color:#330066; text-align:center; padding:5px; font-size:24px;"></dd> 	
				<dt style="background:#FFFFFF; color:#a64dff; text-align:left; padding:5px; font-size:14px;"></dt>	
				<dd style="background:#FFFFFF; color:#a64dff; text-align:center; padding:5px; font-size:14px;"></dd> 	 	
				<hr>	
	...
	<div style="width: 100%; float: left;">
		<c:if test = "${agencySize > 0}">	
			...
			<c:if test = "${agencyPaySize > 0}">	
					<table  class="tableCharge"  style="width:100%; float: right;";>
						<tr><td colspan=5 style="border-top: 1px solid #000;  background:#FFFFFF; color:#6666cc;">Payments</td></tr>
						  <tr>
				...
				<c:if test = "${agencySize > 0}">	
					<table  class="tableCharge"  style="width:100%; float: right;";>
						<tr><td colspan=6 style="border-top: 1px solid #000; background:#FFFFFF; color:#6666cc;">Totals: </td></tr>
			...
			<table class="tableCharge" style="width:100%;";>
				<tr><td colspan=6 style="background:#6666cc;">Totals: </td></tr> 	
				 <tr >
						<td style="font-size:18px;">Balance</td> 
						<td style="font-size:18px;">$ <c:out value="${reservation.totalAgency}" /></td>
				 </tr>		
			</table>
		</c:if>
		<c:if test = "${agencySize < 1}">	
			<dl class="list"; style="font-size:14px;">
				<dt style="background:#FFFFFF; color:#330066; text-align:center; padding:5px; font-size:24px;">There are no associated charges to Agency</dt>	
				<dd style="background:#FFFFFF; color:#330066; text-align:center; padding:5px; font-size:24px;"></dd> 	
			</dl>
		</c:if>
