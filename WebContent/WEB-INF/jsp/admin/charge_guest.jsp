...
<div style="width: 100%; float: left;">
		<div style="width: 33%; float: left;">
			<dl class="list"; style="font-size:14px;">
				<dt style="background:#FFFFFF; color:#194d33; text-align:center; padding:5px; font-size:24px;">Guest Charges</dt>	
				<dd style="background:#FFFFFF; color:#194d33; text-align:center; padding:5px; font-size:24px;"></dd> 	
				<dt style="background:#FFFFFF; color:#78d3a6; text-align:left; padding:5px; font-size:14px;"><c:out value="${reservation.reservation_number}" /></dt>	
				<dd style="background:#FFFFFF; color:#78d3a6; text-align:center; padding:5px; font-size:14px;"></dd> 	 	
				<hr>	 
		...
		<div style="width: 34%; float: left;">
			<dl class="list"; style="font-size:14px;">
				<dt style="background:#FFFFFF; color:#194d33; text-align:center; padding:5px; font-size:24px;"></dt>	
				<dd style="background:#FFFFFF; color:#194d33; text-align:center; padding:5px; font-size:24px;"></dd> 	
				<dt style="background:#FFFFFF; color:#78d3a6; text-align:left; padding:5px; font-size:14px;"></dt>	
				<dd style="background:#FFFFFF; color:#78d3a6; text-align:center; padding:5px; font-size:14px;"></dd> 	 	
				<hr>	
	...
	<div style="width: 100%; float: left;">
		<c:if test = "${guestSize > 0}">	
				<table  class="tableCharge"  style="width:100%; float: right;";>
					 <tr><td colspan=7 style="background:#339966;">Guest</td></tr>
					 <tr><td colspan=7 style="border-top: 1px solid #000; background:#FFFFFF; color:#339966; font-size:14px; font-weight: bold; ">Charges</td></tr>
					   <tr>
			...
			<c:if test = "${guestPaySize > 0}">	
					<table  class="tableCharge"  style="width:100%; float: right;";>
						<tr><td colspan=5 style="border-top: 1px solid #000; background:#FFFFFF; color:#339966;">Payments</td></tr>
						   <tr>
		...
		<c:if test = "${guestSize < 1}">	
			<dl class="list"; style="font-size:14px;">
				<dt style="background:#FFFFFF; color:#194d33; text-align:center; padding:5px; font-size:24px;">There are no associated charges to Guest</dt>	
				<dd style="background:#FFFFFF; color:#194d33; text-align:center; padding:5px; font-size:24px;"></dd> 	
			</dl>
		</c:if>
