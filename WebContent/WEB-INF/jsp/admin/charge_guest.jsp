...
<div style="width: 100%; float: left;">
	...
	<div style="width: 100%; float: left;">
		<div style="width: 100%; font-size:14px;">
			<dl class="list">
				<dt style="background:#FFFFFF; color:#78d3a6; text-align:left; padding:5px; font-size:14px;">Rooms Related</dt>	
				<dd style="background:#FFFFFF; color:#78d3a6; text-align:center; padding:5px; font-size:14px;"></dd> 	
			</dl>
				<hr>
			<ul>
	...
	<div style="width: 100%; float: left;">
		<c:if test = "${guestSize > 0}">	
			...
			<tr><td colspan=6 style="background:#339966;">Guest Charges: </td></tr>
				  <tr>
