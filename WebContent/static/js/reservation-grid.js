																			    ...
																			    listeners:{
																	        		check: function(self, newVal, oldVal) {
																        				...
																        				/*	 Ext.MessageBox.prompt({
																        					...
																        					if(panel.reservationInfo !== undefined){
																        						Ext.getCmp("card_no").setValue( panel.reservationInfo.card_no );
																        					}
        ...
        showPaymentWindow : function (data){
        	...
        	if(Ext.getCmp('reservation_type').getValue() == 3){
        		back_account_store = new Ext.data.ArrayStore({
    		        ...
    		        data: [
    		               ['none', 'none'],
    		               ['100­01­013­005188­2','BN CRC #100-01-013-005188-2'],
    		               ['100­02­013­600429­6','BN USD #100-02-013-600429-6'],
    		               ['909516734','BAC CRC #909516734'],
    		               ['909517005','BAC USD #909517005']
    		              ]
    		    });
        	}else {
        		back_account_store = new Ext.data.ArrayStore({
    		        ...
    		        data: [
    		               ['none', 'none'],
    		               ['100­01­013­005132­7','BN CRC #100-01-013-005132-7'],
    		               ['100­02­013­600411­3','BN USD #100-02-013-600411-3'],
    		               ['906486436','BAC CRC #906486436'],
    		               ['906490388','BAC USD #906490388']
    		               ]
    		    });
        	}
											...
											},
											{
												...
												listeners:{
													select: function (t,n,o) {
													  Ext.getCmp('receive_date').setValue(t.value);
												   }},
