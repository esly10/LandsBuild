ChargeGuestPanel = Ext.extend(Ext.Panel, {
		charge: null,
		initComponent: function()
	    {
			...
			var config = 
			{
				xtype: 'panel',
			    title: 'Guest Charges',
			    id: 'chargetab-guest-' + panel.charge.room_id,
			    padding: 5,
			    bodyCssClass: 'x-citewrite-panel-body',
			    autoScroll: true,
			    buttonAlign: 'left',
			    autoLoad : { url : _contextPath + '/rooms/details', scripts : true, params: {room_id: panel.charge.room_id, date: panel.date.value, selector: 3 } },
			    buttons:  buttons
			};
